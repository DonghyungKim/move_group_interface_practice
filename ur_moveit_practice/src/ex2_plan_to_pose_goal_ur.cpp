// Ex 2 - Planning to a Pose goal, UR robots
...
int main(int argc, char** argv)
{
  ...
  tf2::Quaternion q_ee;
  q_ee.setRPY(D2R*(180.0), 0.0, 0.0);  // Target orientation of end-effector frame

  geometry_msgs::msg::Pose target_pose;
  target_pose.orientation.x = q_ee.getX();
  target_pose.orientation.y = q_ee.getY();
  target_pose.orientation.z = q_ee.getZ();
  target_pose.orientation.w = q_ee.getW();

  target_pose.position.x = 0.45;         // Target (x, y, z) position of end-effector frame
