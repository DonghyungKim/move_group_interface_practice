// Ex 3 - Planning with Path constraints, UR robots
...
int main(int argc, char** argv)
{
  ...
  target_pose.orientation = move_group.getCurrentPose().pose.orientation; // Target orientation of end-effector frame
